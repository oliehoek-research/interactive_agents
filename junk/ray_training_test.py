'''
Script to test using Ray for distributed training.

Currently just launches a number of identical R2D2 training runs.
Eventually we will implement distributed sampling within runs.
'''
import gym
